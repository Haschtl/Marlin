 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    #define X2_CHAIN_POS     0  // 0 - Not chained, 1 - MCU MOSI connected, 2 - next in chain, ...
  #endif
    ...
    #define Y_CHAIN_POS     0  // 0 - Not chained, 1 - MCU MOSI connected, 2 - next in chain, ...
  #endif
    ...
    #define Y2_CHAIN_POS     0  // 0 - Not chained, 1 - MCU MOSI connected, 2 - next in chain, ...
  #endif
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_SCRIPT_DONE "M117 Benutzer Skript beendet"
