...
//
  ...
  #define HEATER_CHAMBER_PIN      -1 //P2_04   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_DEFAULT_ON fals          // Set default power-up state on
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.16, 0.14, 0 } // (mm) One value for each linear axis
  ...
  #define BACKLASH_SMOOTHING_MM 4 // (mm)
...
#define CALIBRATION_GCODE
  ...
  // Define the pin to read during calibration
    ...
    #define CALIBRATION_PIN PC5            // Define here to override the default pin
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      600 //100  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     600 //0 // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH       600  // 8  // (mm) An unretract is done, then this length is purged.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1000 //1400       // (mA) RMS current. Multiply by 1.414 for peak current.
...
#define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 Benutzer Skript abgeschlossen"
#define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
//#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
#define CUSTOM_MENU_MAIN_ONLY_IDLE // Only show custom menu when the machine is idle

#define MAIN_MENU_ITEM_1_DESC "Einfacher Z-Probe"
#define MAIN_MENU_ITEM_1_GCODE "G30 E0"
//#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

#define MAIN_MENU_ITEM_2_DESC "Motortreiber initialisieren"
#define MAIN_MENU_ITEM_2_GCODE "M81\nM80"
//#define MAIN_MENU_ITEM_2_CONFIRM

#define MAIN_MENU_ITEM_3_DESC "Unified-Bed-Leveling"
#define MAIN_MENU_ITEM_3_GCODE "M190 S65\nG28\nG29 P1\nG29 S-1\nG29 A"
//#define MAIN_MENU_ITEM_3_CONFIRM

#define MAIN_MENU_ITEM_4_DESC "Druck-Workspace"
#define MAIN_MENU_ITEM_4_GCODE "G53"
//#define MAIN_MENU_ITEM_4_CONFIRM

#define MAIN_MENU_ITEM_5_DESC "Laser-Workspace"
#define MAIN_MENU_ITEM_5_GCODE "G53\nG28\nG54\nG90\nG1 X0 Y185 Z300\nG92 X0 Y145 Z271\nM500\nG28"
