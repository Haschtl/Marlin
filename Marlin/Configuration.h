/**
MISSING FEATURES: EMERGENCY_PARSER, FAST_PWM_FAN, SENSORLESS_HOMING, PSU_CONTROL, PREVENT_COLD_EXTRUSION, CHAMBER_AUTO_FAN_PIN, QUICK_HOME
Opts: MARLIN_DEV_MODE, SDCARD_SORT_ALPHA, PRINTCOUNTER
...
#define CUSTOM_MACHINE_NAME "Kellerdrucker"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "09e6adb0-76a0-4aab-8a8e-fce798c9bf98"
...
#define PID_K1 1//0.95      // Smoothing factor within any PID loop
#if ENABLED(PIDTEMP)
